...
const CASES: Case[] = [
  ...
  { name: "d/f+3", script: S.press(B3, { dx: 1, dy: -1 }), block: -7 },
  ...
  { name: "d/b+3", script: S.press(B3, { dx: -1, dy: -1 }), block: -12 },
  { name: "d/b+4", script: S.press(B4, { dx: -1, dy: -1 }), block: -8, low: true },
  { name: "b+2", script: S.press(B2, { dx: -1 }), block: -10 },
  { name: "b+3", script: S.press(B3, { dx: -1 }), block: 0 },
  ...
  { name: "WS+2", script: S.ws(B2), block: -2 },
