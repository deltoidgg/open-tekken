...
`+0x74`, one's-complement facing-error magnitude `+0x80`, logical per-frame
displacement `+0x11C/+0x120/+0x124`, composed
...
`+0x1BE`, entry countdown `+0x2CA`, decoded requirements `111/112/115/116/172`,
and live pushback state at `+0x2A4` through `+0x2F0`. All eight
